    ...
    api: {
        key: async (req, res, next) => {
            try {
                ...
                if(response_jwt.data.status === 'admin') {
                    ...
                    req.userdata_user = response_jwt.data
                }
        ...
        admin_only: async (req, res, next) => {
            try {
                ...
                const response_new_userdata = await tables_function.v1.admin.get_by_id(userdata['id'])
        ...
        user_only: async (req, res, next) => {
            try {
                const userdata = req.userdata_user
                ...
                const response_new_userdata = await tables_function.v1.user.get_by_id(userdata['id'])
                ...
                req.userdata_user = new_userdata
